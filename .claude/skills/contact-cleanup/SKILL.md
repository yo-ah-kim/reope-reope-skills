...
1. `crm-schema.md` — Drive ID `1bj9rPxHT4UWqnMmtdr43XyuXMYHa93z7L8EDAVKoCxA` — Pipeline stage IDs (Development + Toolbox: open, won, lost), portal ID for record URLs, Joachim's `hubspot_owner_id`
